...
const url = 'https://bss.bcit.ca/owa_prod/twbkwbis.P_WWWLogin?ret_code=E'
const testCrawler = (options) => {
    return new Promise(async (resolve, reject) => {
        let {page, data, id} = options
        ...
        try {
            ...
            await page.waitFor('td.pldefault h2', {timeout: 2000}).catch(e => {
                throw 'can\' go next page'
            })
